...
> Select customer ID from 'Visits' table.
> Left Join the 'Transactions' table on visit ID.
> Filter the returned rows for where transaction ID is null in the 'Transactions' table, indicating no purchases were made during a visit.
