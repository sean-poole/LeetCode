...
> Select student Id and student name from 'Students' table.
> Select subject name from 'Subjects' table.
> Cross join between the 'Students' and 'Subjects' table to get all possible combinations.
> Left join the 'Examinations' table on student Id matches and subject name matches.
